							...
							<div >
								...
								<aside>
									<div className=" md:flex  md:space-x-10 ">
										<div className="w-1/2 ">
											<Image
												className=" h-1/2 w-2/3 rounded-full object-cover shadow-md md:!h-[22rem] md:!w-full md:rounded-2xl  lg:w-[26rem]"
										...
										<blockquote className="border rounded-lg bg-card mt-3 p-4 md:max-w-sm self-start">
