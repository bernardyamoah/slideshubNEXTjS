...
//             Welcome to <span className="font-bold border-b-2 border-dashed text-emerald-600 border-emerald-700">SlidesHub</span> where learning is a breeze🍃! No more endless searches or library trips. With a few clicks, download and print lecture slides and books. Education made easy!
//             </p>
//             <Button className="flex gap-2 mx-auto text-center " onClick={handleRouteToCampus}> Get Started <ChevronRightCircleIcon className="w-5 h-5 "/> </Button>
...
const Hero = () => {
  ...
  const handleRouteToCampus = () => {
   route.push("/campus");}
  return (
    <section className="flex flex-col gap-10 max-container padding-container md:gap-16 lg:py-6 xl:flex-row">
      ...
      <div className="relative z-20 flex flex-1 ">
        ...
        Welcome to <span className="font-bold border-b-2 border-dashed text-emerald-500 border-emerald-400">SlidesHub</span> where learning is a breeze🍃! No more endless searches or library trips. With a few clicks, download and print lecture slides and books. Education made easy!
        </p>
        <div className="flex flex-wrap gap-5 my-6 xl:justify-center">
