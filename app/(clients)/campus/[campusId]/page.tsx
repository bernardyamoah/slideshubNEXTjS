  ...
  return (
    ...
    <>
      ...
      <div className="p-2 mx-auto text-center max-w-4xl ">
        ...
        <h2 className=" uppercase text-2xl text-transparent dark:text-zinc-100 sm:text-4xl xl:text-5xl/none bg-clip-text dark:bg-gradient-to-r dark:from-zinc-500 dark:to-zinc-700 bg-gradient-to-r from-zinc-800 to-zinc-700 ">  {name}
        </h2>
