			...
			<Card className="overflow-hidden rounded-lg   p-4 sm:p-6 lg:p-8 ">
				...
				<div className="sm:flex sm:justify-between sm:gap-4">
					<div>
						<Badge
							variant="outline"
							className="mb-3 dark:border-zinc-700 rounded-3xl py-1.5"
						>
							{book.categories}
						</Badge>
						<h3 className="text-lg font-bold sm:text-xl">{book.title}</h3>
				...
				<div className="mt-4">
					<p className="max-w-[60ch] text-sm text-gray-500 line-clamp-2">
						{book.description}
					</p>
					<Link target="_blank" className="mt-3 " href={book.previewLink}>
						Preview Here
					</Link>
				</div>
