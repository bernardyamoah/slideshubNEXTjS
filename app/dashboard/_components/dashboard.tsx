...
export default function Dashboard() {
	...
	return (
		<>
			<header className=" items-center justify-center w-full ">
				<div className="max-w-screen-xl px-4 py-8 mx-auto">
					<div className="space-y-2">
						...
						<motion.h1
							className="text-3xl font-bold tracking-tighter text-center sm:text-4xl bg-clip-text dark:bg-gradient-to-r dark:from-zinc-200 dark:to-zinc-100 bg-gradient-to-r from-black to-zinc-600"
							initial="hidden"
			...
			<div className="relative col-span-3 lg:col-span-4 bg-background/30  backdrop-blur-sm">
